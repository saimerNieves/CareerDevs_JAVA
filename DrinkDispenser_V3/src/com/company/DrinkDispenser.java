...
public class DrinkDispenser {
    ...
    public ArrayList<Syrup> syrups_Array; // Collection of multiple instances of Syrup Class.
    ...
    public DrinkDispenser(int small_vol_int, int medium_vol_int, int large_vol_int){
        this.syrups_Array = new ArrayList<>();
    ...
    public void serveDrink(String size_str,int syrup_index){
        ...
        switch(size_str.toLowerCase()){
         ...
         String drinkName = syrups_Array.get(syrup_index).dispense(volume); //After the cup is dispensed in your hand the syrup ArrayList will get called with an index and it will dispense the volume value return from the cup

        //Output should be size and drink
    ...
    public void addSyrup(String name, int volume){
        syrups_Array.add(new Syrup(name, volume)); // This is building using a constructor that takes the name and volume of drink
    }
