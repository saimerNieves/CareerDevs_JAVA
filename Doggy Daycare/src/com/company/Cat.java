...
public class Cat extends Animal{
    ...
    public Cat(int legs_input, String size_input, boolean isFixed_input, String name_input, boolean isBornInAmerica_input, String pattern_input, boolean wasStray_input, boolean isAggressive_input){
